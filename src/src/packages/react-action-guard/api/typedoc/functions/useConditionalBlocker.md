...
Defined in: [src/hooks/useConditionalBlocker/useConditionalBlocker.ts:151](https://github.com/okyrychenko-dev/react-action-guard/blob/main/src/hooks/useConditionalBlocker/useConditionalBlocker.ts#L151)
