...
Defined in: [src/hooks/useBlockingInfo/useBlockingInfo.ts:82](https://github.com/okyrychenko-dev/react-action-guard/blob/main/src/hooks/useBlockingInfo/useBlockingInfo.ts#L82)
