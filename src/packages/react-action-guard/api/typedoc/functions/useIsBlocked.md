...
Defined in: [src/hooks/useIsBlocked/useIsBlocked.ts:75](https://github.com/okyrychenko-dev/react-action-guard/blob/main/src/hooks/useIsBlocked/useIsBlocked.ts#L75)
